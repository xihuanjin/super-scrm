...
public class ScrmConfig {
    ...
    /**
     * 部署模式: "private"(私有化单企业) 或 "saas"(多租户)
     */
    ...
    public void setDeployMode(String deployMode) {
        ScrmConfig.deployMode = deployMode;
    }
    ...
    public static boolean isSaasMode() {
        return "saas".equalsIgnoreCase(deployMode);
    }
    ...
    // ==================== 相对路径（不含 domainName，供 CorpConfigContext 使用） ====================

    public static String getCustomerDetailRelativePath() {
        return customerDetailUrl;
    }

    public static String getGroupChatWelcomeRelativePath() {
        return groupChatWelcomeUrl;
    }

    public static String getMediaInfoRelativePath() {
        return mediaInfoUrl;
    }

    public static String getFollowDetailRelativePath() {
        return followDetailUrl;
    }

    public static String getSaleReportRelativePath() {
        return saleReportUrl;
    }

    public static String getFissionEventRelativePath() {
        return fissionEventUrl;
    }
    ...
    public static String getTempAuthCallbackRelativePath() {
        return tempAuthCallbackUrl;
    }

    public static String getLoginCallbackRelativePath() {
        return loginCallback;
    }

    // ==================== 兼容：完整URL（domainName + relativePath） ====================
